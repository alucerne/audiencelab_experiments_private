...
export function SetPasswordForm(params: { redirectTo: string }) {
  ...
  return (
    <div className={'flex flex-col space-y-4'}>
      <Alert variant={'success'}>
        ...
        <AlertTitle>Account creation successful</AlertTitle>
...
function ErrorState(props: {
  ...
  const errorMessage = t(`errors.${props.error.code}`, {
    defaultValue: 'Sorry, we could not create your account. Please try again.',
  });

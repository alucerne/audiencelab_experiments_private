...
SELECT public.upsert_order(makerkit.get_account_id_by_slug('audiencelab'), 'cus_test', 'order_test', 'pending', 'stripe', 100, 'usd', '[
...
SELECT public.upsert_order(makerkit.get_account_id_by_slug('audiencelab'), 'cus_test', 'order_test', 'succeeded', 'stripe', 100, 'usd', '[
    {"id":"order_item_1", "product_id": "prod_test", "variant_id": "var_test", "price_amount": 100, "quantity": 1},
